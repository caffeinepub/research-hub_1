      ...
      >
        ...
        <ScrollArea className="flex-1">
          <div className="p-4">
            {loadingText ? (
              <div
                data-ocid="ebooks.loading_state"
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex gap-2">
        ...
        <Button
          type="button"
          data-ocid="ebooks.primary_button"
      ...
      {!loading && books.length === 0 && (
        ...
        >
          ...
          >
            Or tap a genre chip to browse by category
          </p>
        </div>
      )}
